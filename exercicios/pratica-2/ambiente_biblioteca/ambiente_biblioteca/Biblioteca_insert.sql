...
insert into pessoa (pes_cod,pes_nome,cpf,rg,email) values(6,'Paulo','55555555555',6894587,'adriana@gmail.com');
...
insert into aluno (pes_cod,pes_nro_matricula) values (6,34567833);
